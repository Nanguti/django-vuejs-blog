<template>
  <guest-layout>
    <div
      class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 px-6"
    >
...
const login = async () => {
  try {
    ...
    if (response.status === 200 && response.data.auth_token) {
      ...
      console.log("get accesstoken here " + accessToken);
      ...
      console.log("rsponse here " + userResponse);
