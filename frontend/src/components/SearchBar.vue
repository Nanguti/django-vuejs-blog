...
<template>
  <div>
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div
        class="relative isolate overflow-hidden bg-white px-6 py-20 text-center sm:px-16 sm:shadow-sm rounded-md"
      >
        <p
          class="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl"
        >
          Didn't find article you were looking for?
        </p>
...
const emit = defineEmits(["goToSearchResults"]);
const handleSearchPosts = () => {
  emit("goToSearchResults", searchQuery);
};
</script>
